            ...
            <div className="flex-1 flex">
                ...
                <div className="w-96 bg-[#0a0a0a] p-6 overflow-y-auto">
                    ...
                    <div className="space-y-2">
                        <div className="bg-[#111] border border-[#1a1a1a] p-3 rounded-lg flex items-center justify-between">
                            <div className="flex items-center space-x-3">
                                <div className="p-2 bg-red-900/20 rounded">
                                    <Music size={14} className="text-red-500" />
                                </div>
                                <span className="text-[10px]">Epic_Orchestral_Main.mp3</span>
                            </div>
                            <button className="p-1 hover:text-red-500"><Play size={14} /></button>
                        </div>
                    </div>
                </div>
            </div>
